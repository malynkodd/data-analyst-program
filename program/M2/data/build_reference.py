...
ASCII-вывод намеренно: категории на кириллице печатаются кодами
(laptops/phones/...), не самим текстом - см. довод в
program/M1/data/count_active.py и program/M0/data/README.md.
"""
