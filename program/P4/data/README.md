...
| `ref_match_report.csv.enc` | Эталонная таблица `ref_match_report.csv` — в этом проекте она и есть ответ на вопрос заказчика. |
| `ref_top10_suppliers.csv.enc` | Эталонная таблица `ref_top10_suppliers.csv` — в этом проекте она и есть ответ на вопрос заказчика. |
| `ref_totals_comparison.csv.enc` | Эталонная таблица `ref_totals_comparison.csv` — в этом проекте она и есть ответ на вопрос заказчика. |
| `ref_unmatched_report.csv.enc` | Эталонная таблица `ref_unmatched_report.csv` — в этом проекте она и есть ответ на вопрос заказчика. |
