...
Значения полей — латиница/ASCII: M0 на латинице по решению 17 (навык
этого модуля — терминал и запуск скриптов, а не работа с кириллическим
контентом; готовность терминала к кириллице проверяется отдельно,
